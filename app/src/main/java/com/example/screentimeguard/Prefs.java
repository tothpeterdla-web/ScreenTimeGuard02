...
public final class Prefs {
    ...
    public static Set<String> getExtraAllowedPackages(Context context) {
        Set<String> stored = prefs(context).getStringSet(KEY_EXTRA_ALLOWED_PACKAGES, Collections.emptySet());
    ...
    public static void setExtraAllowedPackages(Context context, Set<String> packages) {
        prefs(context).edit().putStringSet(KEY_EXTRA_ALLOWED_PACKAGES, new HashSet<>(packages)).apply();
    }
